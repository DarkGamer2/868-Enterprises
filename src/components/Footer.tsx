  ...
  return (
    <div className="bg-blue-800 p-4 mt-auto"> {/* Added mt-auto */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div>
          <h1 className="text-center text-white font-inter text-xl">Partners</h1>
          ...
          <p className="text-white text-center font-lato">868 Modeling Division</p>
        </div>
        <div>
        ...
        <div>
          <h1 className="text-center text-white font-inter text-xl">Developer Information</h1>
          <p className="text-white text-center font-lato">Neon Technologies Limited</p>
          <p className="text-white text-center font-lato">Contact: +1 (868) 366-6331</p>
        </div>
      </div>
